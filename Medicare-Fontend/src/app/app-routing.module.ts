...
const routes: Routes = [
  ...
  { path: 'user/search/product/:name', component: ListProducts, pathMatch: 'full', title: 'Search results' },
  { path: 'show/product/class/:category', component: ListProducts, pathMatch: 'full', title: 'All Products' },
  { path: 'get/all/class/:category', component: ListProducts, pathMatch: 'full', title: 'All Products' },
